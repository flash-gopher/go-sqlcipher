...
[![GoDoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](http://godoc.org/github.com/flash-gopher/go-sqlcipher) [![CI](https://github.com/flash-gopher/go-sqlcipher/workflows/CI/badge.svg)](https://github.com/flash-gopher/go-sqlcipher/actions)
...
To upgrade your Go code to the 4.x series, change the import path to
    ...
    "github.com/flash-gopher/go-sqlcipher/v4"

### Installation

This package can be installed with the go get command:

    go get github.com/flash-gopher/go-sqlcipher
...
http://godoc.org/github.com/flash-gopher/go-sqlcipher

Use the function
[sqlite3.IsEncrypted()](https://godoc.org/github.com/flash-gopher/go-sqlcipher#IsEncrypted)
